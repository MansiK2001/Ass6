...
public class  petstoreSwaggerApiTest {
    ...
    public void Createuser(){
        ...
        RequestBody requestBody  =  RequestBody.create(new File("C:\\Users\\VICTUS\\Documents\\Driver\\ASS6\\src\\test\\java\\createpet.json"), MediaType.parse("application/json"));
    ...
    public void CreateArrayuserList(){
        ...
        OkHttpClient client = new OkHttpClient();
        RequestBody requestBody  =  RequestBody.create(new File("C:\\Users\\VICTUS\\Documents\\Driver\\ASS6\\src\\test\\java\\arrayPostlistpet.json"), MediaType.parse("application/json"));
        Request request  = new Request.Builder()
    ...
    @Test
            ( description= "updateuser a user Resourcen in  swagger Server", priority = 4)
    public void updateuser(){
        OkHttpClient client = new OkHttpClient();
        RequestBody requestBody  =  RequestBody.create(new File("C:\\Users\\VICTUS\\Documents\\Driver\\ASS6\\src\\test\\java\\updateuser.json"), MediaType.parse("application/json"));
        Request request  = new Request.Builder()
                .url("https://petstore.swagger.io/v2/user")
                //  .header("Connection","keep-alive")
                .header("accept","application/json")
    ...
    @Test
            ( description= "get a user Resourcen in  swagger Server", priority = 5)
    public void getCreateuser2(){
        OkHttpClient client = new OkHttpClient();
        String email ="riyak@gmail.com";
        Request request = new Request.Builder()
